...
${OBJECTDIR}/img_diff.o: img_diff.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../../../../opencv/build/include -I../../../../../opencv/build/include/opencv -MMD -MP -MF $@.d -o ${OBJECTDIR}/img_diff.o img_diff.cpp
